Instance: CefuroximMIP-1500mg-Powder-SE-IS
InstanceOf: Bundle
Usage: #example
* type = #batch
* insert AddEntry(MedicinalProductDefinition,CefuroximMIP-1500mg-Powder-SE-IS-MedicinalProductDefinition)
* insert AddEntry(RegulatedAuthorization,CefuroximMIP-1500mg-Powder-SE-IS-RegulatedAuthorization)
* insert AddEntry(AdministrableProductDefinition,CefuroximMIP-1500mg-Powder-SE-IS-AdministrableProductDefinition)
* insert AddEntry(PackagedProductDefinition,CefuroximMIP-1500mg-Powder-SE-IS-PackagedProductDefinition)
* insert AddEntry(ManufacturedItemDefinition,CefuroximMIP-1500mg-Powder-SE-IS-ManufacturedItemDefinition)
* insert AddEntry(Ingredient,CefuroximMIP-1500mg-Powder-SE-IS-Ingredient)
...
Instance: CefuroximMIP-1500mg-Powder-SE-IS-AdministrableProductDefinition
InstanceOf: AdministrableProductDefinition
Usage: #inline
* status = #active
* formOf = Reference(CefuroximMIP-1500mg-Powder-SE-IS-MedicinalProductDefinition)
* administrableDoseForm = $200000000004#100000074038 "Solution for injection/infusion"
* producedFrom = Reference(CefuroximMIP-1500mg-Powder-SE-IS-ManufacturedItemDefinition)
...
* package.package.containedItem.item.reference = Reference(CefuroximMIP-1500mg-Powder-SE-IS-ManufacturedItemDefinition)

Instance: AtomoxetinGlenmark-10mg-Capsul
InstanceOf: Bundle
Usage: #example
* type = #batch
* insert AddEntry(MedicinalProductDefinition,AtomoxetinGlenmark-10mg-Capsule-SE-AJ-MedicinalProductDef)
* insert AddEntry(RegulatedAuthorization,AtomoxetinGlenmark-10mg-Capsule-SE-AJ-RegulatedAuthorization)
* insert AddEntry(AdministrableProductDefinition,AtomoxetinGlenmark-10mg-Capsule-SE-AJ-AdministrableProductDef)
* insert AddEntry(PackagedProductDefinition,AtomoxetinGlenmark-10mg-Capsule-SE-AJ-PackagedProductDef)
* insert AddEntry(ManufacturedItemDefinition,AtomoxetinGlenmark-10mg-Capsule-SE-AJ-ManufacturedItemDef)
* insert AddEntry(Ingredient,AtomoxetinGlenmark-10mg-Capsule-SE-AJ-Ingredient)
...
Instance: AtomoxetinGlenmark-10mg-Capsule-SE-AJ-AdministrableProductDef
InstanceOf: AdministrableProductDefinition
Usage: #inline
* status = #active
* formOf = Reference(AtomoxetinGlenmark-10mg-Capsule-SE-AJ-MedicinalProductDef)
* administrableDoseForm = $200000000004#100000073375 "Capsule, hard"
* producedFrom = Reference(AtomoxetinGlenmark-10mg-Capsule-SE-AJ-ManufacturedItemDef)
...
* package.package.material[+] = $200000003199#200000003212 "PolyChloroTriFluoroEthylene"
* package.package.material[+] = $200000003199#200000003214 "PolyEthylene"
* package.package.containedItem.item.reference = Reference(AtomoxetinGlenmark-10mg-Capsule-SE-AJ-ManufacturedItemDef)

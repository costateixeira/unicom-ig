Instance: Aspirin500mgtablett
InstanceOf: Bundle
Usage: #example
* type = #batch
* insert AddEntry(MedicinalProductDefinition,Aspirin500mgtablett-SE-PLC-MedicinalProductDef)
* insert AddEntry(RegulatedAuthorization,Aspirin500mgtablett-SE-PLC-RegAutho)
* insert AddEntry(AdministrableProductDefinition,Aspirin500mgtablett-SE-PLC-AdminProductDef)
* insert AddEntry(PackagedProductDefinition,Aspirin500mgtablett-SE-PLC-PackageProductDef01)
* insert AddEntry(PackagedProductDefinition,Aspirin500mgtablett-SE-PLC-PackageProductDef02)
* insert AddEntry(ManufacturedItemDefinition,Aspirin500mgtablett-SE-PLC-ManufacturedItemDef)
* insert AddEntry(Ingredient,Aspirin500mgtablett-SE-PLC-Ingredient)
...
Instance: Aspirin500mgtablett-SE-PLC-AdminProductDef
InstanceOf: AdministrableProductDefinition
Usage: #inline
* status = #active
* formOf = Reference(Aspirin500mgtablett-SE-PLC-MedicinalProductDef)
* administrableDoseForm = $200000000004#100000073664 "Tablet"
* producedFrom = Reference(Aspirin500mgtablett-SE-PLC-ManufacturedItemDef)
...
* package.shelfLifeStorage.periodDuration = 5 https://spor.ema.europa.eu/v1/lists/100000110633#200000003434 "year"
...
* package.package.containedItem.item.reference = Reference(Aspirin500mgtablett-SE-PLC-ManufacturedItemDef)

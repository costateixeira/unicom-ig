Instance: CBZEssPharm-250mg-Supp-SE-AJ
InstanceOf: Bundle
Usage: #example
* type = #batch
* insert AddEntry(MedicinalProductDefinition,CBZEssPharm-250mg-Supp-SE-AJ-MedicinalProductDefinition)
* insert AddEntry(RegulatedAuthorization,CBZEssPharm-250mg-Supp-SE-AJ-RegulatedAuthorization)
* insert AddEntry(AdministrableProductDefinition,CBZEssPharm-250mg-Supp-SE-AJ-AdministrableProductDefinition)
* insert AddEntry(PackagedProductDefinition,CBZEssPharm-250mg-Supp-SE-AJ-PackagedProductDefinition)
* insert AddEntry(ManufacturedItemDefinition,CBZEssPharm-250mg-Supp-SE-AJ-ManufacturedItemDefinition)
* insert AddEntry(Ingredient,CBZEssPharm-250mg-Supp-SE-AJ-Ingredient)
...
Instance: CBZEssPharm-250mg-Supp-SE-AJ-AdministrableProductDefinition
InstanceOf: AdministrableProductDefinition
Usage: #inline
* status = #active
* formOf = Reference(CBZEssPharm-250mg-Supp-SE-AJ-MedicinalProductDefinition)
* administrableDoseForm = $200000000004#100000073843 "Suppository"
* producedFrom = Reference(CBZEssPharm-250mg-Supp-SE-AJ-ManufacturedItemDefinition)
...
* package.package.containedItem.item.reference = Reference(CBZEssPharm-250mg-Supp-SE-AJ-ManufacturedItemDefinition)

...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:RegulatedAuthorization">
      ...
      <sch:assert test="count(f:region) &gt;= 1">region: minimum cardinality of 'region' is 1</sch:assert>
      <sch:assert test="count(f:region) &lt;= 1">region: maximum cardinality of 'region' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:RegulatedAuthorization/f:region</sch:title>
  ...
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.extension</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:RegulatedAuthorization/f:region/f:coding</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.coding</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:coding">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.coding.extension</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:coding/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.coding.system</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:coding/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.coding.version</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:coding/f:version">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.coding.code</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:coding/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.coding.display</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:coding/f:display">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.coding.userSelected</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:coding/f:userSelected">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.region.text</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:region/f:text">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:RegulatedAuthorization/f:status</sch:title>
  ...
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.extension</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>f:RegulatedAuthorization/f:status/f:coding</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:version) &lt;= 1">version: maximum cardinality of 'version' is 1</sch:assert>
      <sch:assert test="count(f:code) &lt;= 1">code: maximum cardinality of 'code' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.coding</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:coding">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.coding.extension</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:coding/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.coding.system</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:coding/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.coding.version</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:coding/f:version">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.coding.code</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:coding/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.coding.display</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:coding/f:display">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.coding.userSelected</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:coding/f:userSelected">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>RegulatedAuthorization.status.text</sch:title>
    <sch:rule context="f:RegulatedAuthorization/f:status/f:text">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
